...
public class FileHandling {
 ...
 public void createFile() {
    ...
    public void updateLine(int lineNumber, String dataToAppend) {
        ...
        this.deleteLine(lineNumber);this.appendLine(lineNumber, dataToAppend);
    }
...
//    
//    
//    public void writeLine(int lineNumber, String dataToWrite) {
//    try {
//        
